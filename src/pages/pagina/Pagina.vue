  ...
  methods:{
    atualizaPagina(){
      ...
      if(usuarioAux){
        ...
        this.$http.get(this.$urlAPI+'conteudo/pagina/lista/'+this.$route.params.id,{"headers":{"authorization":"Bearer "+this.$store.getters.getToken}})
        .then(response => {
          ...
          if(response.data.status){
            ...
            this.$http.get(this.$urlAPI+'usuario/listaamigospagina/'+this.donoPagina.id,{"headers":{"authorization":"Bearer "+this.$store.getters.getToken}})
            .then(response => {
              if(response.data.status){
